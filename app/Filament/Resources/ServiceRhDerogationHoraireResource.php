...
use App\Filament\Resources\ServiceRhDerogationHoraireResource\RelationManagers;
use App\Models\ServiceRhDerogationHoraire;
use Filament\Forms;
...
{
    protected static ?string $model = ServiceRhDerogationHoraire::class;
